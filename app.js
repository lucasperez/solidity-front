...
$("#transfer").click(function() {
  ...
  var value = $("#value").val()
  contract.contract_instance.transfer(toAccount, value, {from: fromAccount ,gas: 210000}, function (error, result) {
    if (error)
      console.log(error)
  });
...
function Contract() {
  this.contract_id = "0x345ca3e014aaf5dca488057592ee47305d9b3e10"
